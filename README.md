...
- 🧠 Deep Learning-based image classification (Organic vs Recyclable waste)
- 🌐 Flask web app for easy user interaction
- 📸 Upload and preview images before prediction
- 💡 Real-time prediction with confidence score
- 🎨 Modern and responsive frontend with HTML, CSS, and JavaScript
